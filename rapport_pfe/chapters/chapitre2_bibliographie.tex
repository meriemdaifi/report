...
\begin{tikzpicture}[scale=0.8]
    \foreach \x/\w/\label/\bits/\color in {
        0/0.5/SOF/1 bit/yellow!30,
        0.5/2.5/Identifiant/11 bits/stellantisblue!20,
        3.0/0.5/RTR/1 bit/green!20,
        3.5/1.5/Contrôle/6 bits/orange!20,
        5.0/4.0/Données/0-8 octets/red!15,
        9.0/2.0/CRC/16 bits/purple!20,
        11.0/0.5/ACK/2 bits/cyan!20,
        11.5/1.0/EOF/7 bits/gray!20
    } {
        \draw[thick, fill=\color] (\x, 0) rectangle (\x+\w, 1.5);
        \node[text width=\w cm, align=center, font=\tiny\bfseries] at (\x+\w/2, 1.0) {\label};
        \node[text width=\w cm, align=center, font=\tiny] at (\x+\w/2, 0.4) {\bits};
    }
\end{tikzpicture}
